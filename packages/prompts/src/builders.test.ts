...
describe('buildSystemPrompt', () => {
	...
	test('includes structured summary section and approach guidance', () => {
		...
		expect(prompt).toContain('Treat this as the reviewer-facing explanation')
		expect(prompt).toContain('Do **not** just restate the `files` list')
		expect(prompt).toContain('Include every touched file')
